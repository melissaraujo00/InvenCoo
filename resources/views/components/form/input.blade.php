@props([
    ...
    'readonly' => false,
    'helper' => null,
    'errorName' => null, // Para casos donde el error tiene otro nombre
])
...
@php
    ...
    $baseClasses = 'dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30';
