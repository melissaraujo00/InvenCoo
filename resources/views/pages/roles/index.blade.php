                ...
                <div class="flex justify-end gap-3 text-gray-500 dark:text-gray-400">
                    ...
                    @if($role->name !== 'Administrador')
                        <x-modal.confirmation
                            title="Eliminar Rol"
                            :message="'¿Estás seguro que deseas eliminar el rol'"
                            :itemName="$role->name"
                            warning="Los usuarios con este rol perderán todos sus permisos."
                        ...
                        >
                            <x-slot name="trigger">
                                <button type="button" class="hover:text-red-500 transition-colors" title="Eliminar rol">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
