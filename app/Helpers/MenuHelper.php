...
class MenuHelper
{
        ...
        return self::filterMenu([
            ...
            [
                ...
                'subItems' => [
                    ...
                    ['name' => 'Categorías', 'path' => '/categories', 'permission' => 'ver categorias'],
            ...
            [
                ...
                'name' => 'Operaciones',
                'subItems' => [
                    ['name' => 'Compras', 'path' => '/buys', 'permission' => 'ver compras'],
                    ['name' => 'Movimientos', 'path' => '/movements', 'permission' => 'ver movimientos'],
                    ['name' => 'Transferencias', 'path' => '/transfers', 'permission' => 'ver transferencias'],
                ]
            ],
            [
                'icon' => 'user-group',
                'name' => 'Directorio y Acceso',
                'subItems' => [
    ...
    {
        // Purgado absoluto. No necesitamos la sección "Others" de la plantilla.
        return [];
    }
